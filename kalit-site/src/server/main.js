...
// const setWebhook = async () => {
//     try {
//         const webhookUrl = `https://kalit-watch-store-5lk7-15ylczgnm-nahomt23s-projects.vercel.app/${TELEGRAM_BOT_TOKEN}`;
//         const response = await axios.post(
//             `https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/setWebhook`,
//             {
//                 url: webhookUrl,
...
const app = express();
app.use(express.json());
app.use(cors({ origin: 'https://kalit-watch-store-5lk7-15ylczgnm-nahomt23s-projects.vercel.app' })); // Adjust origin as needed
